...
{               
    ...
    public UNICODE_BinaryClock ( Color clockElementBaseColour, Color clockBaseContainerColour, Color clockElementEnabledColour, Color clockElementDisabledColour, int tickDelay, int clockElementSize, Color defaultDateStringColour, String fontName, int bufferWidth, int yLocation, float fontSize, String binaryModeEnquiryAnswer )
    {
        ...
        //establish clockElementBase
            //establish main base
            clockBaseContainer = new JPanel ( );
            clockBaseContainer.setBackground ( clockBaseContainerColour );
            
            //establish decimal value list
            int [ ] decimalValues =  { 1, 2, 4, 8 };
            
            //subsidiary bases
                //SEGMENT ZERO - HOURS
                    //ROW 0
                    for ( int i = 0; i < 4; i ++ )
                        clockElementHourSegmentsFirstColumn [ i ] = new UNICODE_ClockElement ( getHoursCreationState ( i ), decimalValues [ i ], clockElementEnabledColour, clockElementDisabledColour, clockElementBaseColour, 0, 0, clockElementSize );
                        
                    //ROW 1
                     for ( int i = 0; i < 4; i ++ )
                        clockElementHourSegmentsSecondColumn [ i ] = new UNICODE_ClockElement ( 0, decimalValues [ i ], clockElementEnabledColour, clockElementDisabledColour, clockElementBaseColour, 0, 0, clockElementSize );
                ...
                //SEGMENT ONE - MINUTES
                    //ROW 0
                    for ( int i = 0; i < 4; i ++ )
                        clockElementMinuteSegmentsFirstColumn [ i ] = new UNICODE_ClockElement ( getOtherCreationState ( i ), decimalValues [ i ], clockElementEnabledColour, clockElementDisabledColour, clockElementBaseColour, 0, 0, clockElementSize );
                        
                    //ROW 1
                     for ( int i = 0; i < 4; i ++ )
                        clockElementMinuteSegmentsSecondColumn [ i ] = new UNICODE_ClockElement ( 0, decimalValues [ i ], clockElementEnabledColour, clockElementDisabledColour, clockElementBaseColour, 0, 0, clockElementSize );
                ...
                //SEGMENT TWO - SECONDS
                    //ROW 0
                    for ( int i = 0; i < 4; i ++ )
                        clockElementSecondSegmentsFirstColumn [ i ] = new UNICODE_ClockElement ( getOtherCreationState ( i ), decimalValues [ i ], clockElementEnabledColour, clockElementDisabledColour, clockElementBaseColour, 0, 0, clockElementSize );
                        
                    //ROW 1
                    for ( int i = 0; i < 4; i ++ )
                        clockElementSecondSegmentsSecondColumn [ i ] = new UNICODE_ClockElement ( 0, decimalValues [ i ], clockElementEnabledColour, clockElementDisabledColour, clockElementBaseColour, 0, 0, clockElementSize );
        ...
        //set background colour of this panel
        setBackground ( clockBaseContainerColour );
