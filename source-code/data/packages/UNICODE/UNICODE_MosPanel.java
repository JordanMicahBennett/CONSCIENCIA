...
public class UNICODE_MosPanel extends JPanel
{
    ...
    //PANEL REPOSITIONING VARS
        //establish current coordinates generated by pressed down mouse
        private Point pressedMouseCoords = null;
        
        //establish current coordinates generated by mouse dragging
    ...
    public UNICODE_MosPanel ( /*JFrame _applicationFrame*/ )
    {
        ...
        buttonDock0 = new UNICODE_MOS_BUTTON_DOCK ( generatedCustomComponentListbuttonDock0 ( ), true, 440, 40, 6, 60, 2220, "clockwise", "horizontal", "data/images/inner menus/moss/main menu/", 84, 84, configurationManager.getColourFromFile ( ), configurationManager.getColourFromFile ( ), "rr", 10, 10, 0 );    
