 ...
 * 
 * @see     data.packages.CUP.production_part
 * @see     data.packages.CUP.symbol_part
 * @see     data.packages.CUP.action_part
...
public class production {
  ...
  protected String make_declaration(
				    ...
				    int     offset)
    {
      ...
      if (emit.lr_values())
        ret = "\t\tint " + labelname + "left = ((data.packages.CUP.runtime.Symbol)" + 
	  emit.pre("stack") + ".elementAt(" + emit.pre("top") + 
	  "-" + offset + ")).left;\n" +
	  "\t\tint " + labelname + "right = ((data.packages.CUP.runtime.Symbol)" + 
	  emit.pre("stack") + ".elementAt(" + emit.pre("top") +
	  "-" + offset + ")).right;\n";
      else ret = "";
	...
	return ret + "\t\t" + stack_type + " " + labelname + " = (" + stack_type + 
	  ")((" + "data.packages.CUP.runtime.Symbol) " + emit.pre("stack") + ".elementAt(" + emit.pre("top") 
	  + "-" + offset + ")).value;\n";
