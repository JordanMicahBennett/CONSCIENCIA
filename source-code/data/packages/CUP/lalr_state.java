 ...
 *
 * @see     data.packages.CUP.lalr_item
 * @see     data.packages.CUP.lalr_item_set
 * @see     data.packages.CUP.lalr_transition
...
public class lalr_state {
   ...
   * @see   data.packages.CUP.lalr_item_set#compute_closure
   * @see   data.packages.CUP.lalr_state#propagate_all_lookaheads
   */
