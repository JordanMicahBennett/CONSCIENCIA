 ...
 *   <dt> -noscanner
 *   <dd> don't refer to data.packages.CUP.runtime.Scanner in the parser
...
public class Main {
	...
	//attributes
	//UPDATE: Jordan Micah Bennett. AKA BUSHMAN
   ...
   *  data.packages.CUP.runtime.Scanner for compatibility with old runtimes? */
...
"    -noscanner     don't refer to data.packages.CUP.runtime.Scanner\n" +
  ...
  protected static void emit_summary(boolean output_produced)
    {
	 ...
	 //build summary data
	 summaryData += "  " + lexer.error_count + " error" + 
	 plural(lexer.error_count) + " and " + lexer.warning_count + 
	 " warning" + plural(lexer.warning_count) + "\n";
	 ...
	 //build summary data
	 summaryData += "  " + terminal.number() + " terminal" + 
			 plural(terminal.number()) + ", " + non_terminal.number() + " non-terminal" + 
			 plural(non_terminal.number()) + ", and " + production.number() + " production" + 
			 plural(production.number()) + " declared, " + "  producing " + lalr_state.number() + 
			 " unique parse states." + "\n";
	 ...
	 //build summary data
	 summaryData += "  " + emit.unused_term + " terminal" + 
			 plural(emit.unused_term) + " declared but not used." + 
			"  " + emit.unused_non_term + " non-terminal" + 
			 plural(emit.unused_term) + " declared but not used." + "\n";
	 ...
	 //build summary data
	 summaryData += "  " + emit.not_reduced + " production" + 
			 plural(emit.not_reduced) + " never reduced."+ "\n";
	 ...
	 //build summary data
	 summaryData += "  " + emit.num_conflicts + " conflict" +
			 plural(emit.num_conflicts) + " detected" +
	                 " (" + expect_conflicts + " expected)."+ "\n";
	...
	System.err.println("  Code written to \"" + emit.parser_class_name + 
	 ...
	 //build summary data
	 summaryData += "  Code written to \"" + emit.parser_class_name + 
	        ".java\", and \"" + emit.symbol_const_class_name + ".java\"."+ "\n";
					 }
      else
	  {
	System.err.println("  No code produced.");
	 ...
	 summaryData += "  No code produced."+ "\n";
		...
		//build summary data
		summaryData += version.version_str + ")"+ "\n";
	}
  ...
  protected static void show_times()
    {
	  ...
	  summaryData += "  Timing Summary" + "\n";
	  
      System.err.println("    Total time       "
        + timestr(final_time-start_time, total_time));
		summaryData += "    Total time       "
        + timestr(final_time-start_time, total_time) + "\n";
